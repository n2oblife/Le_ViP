#include <image_processing/alpha_blend.hpp>
...
int main(int argc, char** argv)
{
    ...
    // Read the images
    Mat foreground = imread(parser.get<String>("foreground"));
    Mat background = imread(parser.get<String>("background"));
    Mat alpha = imread(parser.get<String>("alpha"));
